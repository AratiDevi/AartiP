...
public class PurchaseMenuList extends RW {
	...
	public String Location(WebDriver driver1) throws Exception {
		...
		driver.findElement(By.xpath(data.getData(7, 4, 2))).click();// Click on 
	...
	public String CatalogueItems(WebDriver driver1) throws Exception {
		...
		WebElement submenu = driver.findElement(By.xpath(data.getData(7, 3, 2))); // Click

		action.moveToElement(submenu).build().perform();

		driver.findElement(By.linkText(data.getData(7, 5, 2))).click();// Click
	...
	public String SetItemsMinMaxQty(WebDriver driver1) throws Exception {
		...
		driver.findElement(By.linkText(data.getData(7, 6, 2))).click();// Click
	...
	public String UnitPackings(WebDriver driver1) throws Exception {
		...
		driver.findElement(By.linkText(data.getData(7, 7, 2))).click();// Click
	...
	public String PurchaseQuestionnaire(WebDriver driver1) throws Exception {
		...
		Thread.sleep(100); // Click On purchase menu
		...
		//driver.findElement(By.linkText("Purchase Questionnaire")).click();																
	...
	public String EmailTemplate(WebDriver driver1) throws Exception {
		...
		driver.findElement(By.linkText(data.getData(7, 42, 2))).click();// Click
																		// on
																		// Email
																		// Template
	...
	public String PurchaseSettings(WebDriver driver1) throws Exception {
		...
		driver.findElement(By.linkText(data.getData(7, 8, 2))).click();// Click
	...
	public String CreateNewReqsn(WebDriver driver1) throws Exception {
		...
		driver.findElement(By.linkText(data.getData(7, 9, 2))).click();// Click
	...
	public String PurchaseProcess(WebDriver driver1) throws Exception {
		...
		driver.findElement(By.xpath(data.getData(7, 10, 2))).click();// Click on
	...
	public String ViewReqsnSummary(WebDriver driver1) throws Exception {
		...
		WebElement submenu = driver.findElement(By.linkText(data.getData(7, 11, 2))); // Click

		action.moveToElement(submenu).build().perform();

		driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);

		driver.findElement(By.linkText(data.getData(7, 12, 2))).click();// Click
	...
	public String ViewReqsnAttachments(WebDriver driver1) throws Exception {
		...
		driver.findElement(By.linkText(data.getData(7, 13, 2))).click();// Click
	...
	public String ViewReqsnOnholdHistory(WebDriver driver1) throws Exception {
		...
		driver.findElement(By.linkText(data.getData(7, 14, 2))).click();// Click
	...
	public String InventoryDetails(WebDriver driver1) throws Exception {
		...
		driver.findElement(By.linkText(data.getData(7, 15, 2))).click();// Click
	...
	public String MachineryListing(WebDriver driver1) throws Exception {
		...
		driver.findElement(By.linkText(data.getData(7, 16, 2))).click();// Click
	...
	public String PurchaseReport(WebDriver driver1) throws Exception {
		...
		driver.findElement(By.linkText(data.getData(7, 17, 2))).click();// Click
	...
	public String StalePOReport(WebDriver driver1) throws Exception {
		...
		driver.findElement(By.linkText(data.getData(7, 18, 2))).click();// Click
	...
	public String CreateLogisticPO(WebDriver driver1) throws Exception {
		...
		WebElement submenu = driver.findElement(By.linkText(data.getData(7, 19, 2))); // Click

		action.moveToElement(submenu).build().perform();

		driver.findElement(By.linkText(data.getData(7, 20, 2))).click();// Click
	...
	public String ViewLogisticPO(WebDriver driver1) throws Exception {
		...
		driver.findElement(By.linkText(data.getData(7, 21, 2))).click();// Click
																		// on
	...
	public String ContractPricing(WebDriver driver1) throws Exception {
		...
		WebElement submenu = driver.findElement(By.linkText(data.getData(7, 22, 2))); // Click

		action.moveToElement(submenu).build().perform();

		driver.findElement(By.linkText(data.getData(7, 23, 2))).click();// Click
																		// on
	...
	public String ContractList(WebDriver driver1) throws Exception {
		...
		driver.findElement(By.linkText(data.getData(7, 24, 2))).click();// Click
																		// on
	...
	public String NonContractitems(WebDriver driver1) throws Exception {
		...
		driver.findElement(By.linkText(data.getData(7, 25, 2))).click();// Click
																		// on
	...
	public String CopyContract(WebDriver driver1) throws Exception {
		...
		driver.findElement(By.linkText(data.getData(7, 26, 2))).click();// Click
																		// on
	...
	public String SupplierGroup(WebDriver driver1) throws Exception {
		...
		driver.findElement(By.linkText(data.getData(7, 30, 2))).click();// Click
	...
	public String SupplierApprover(WebDriver driver1) throws Exception {
		...
		driver.findElement(By.linkText(data.getData(7, 31, 2))).click();// Click
																		// on
	...
	public String ManageContacts(WebDriver driver1) throws Exception {
		...
		WebElement submenu = driver.findElement(By.linkText(data.getData(7, 29, 2))); // Click Admin Menu
																						 

		action.moveToElement(submenu).build().perform();

		driver.findElement(By.linkText(data.getData(7, 35, 2))).click();// Click
																		// on Manage Contacts
	...
	public String UserTypeRelationship(WebDriver driver1) throws Exception {
		...
		driver.findElement(By.linkText(data.getData(7, 32, 2))).click();// Click
																		// on
	...
	public String EmailTemplate1(WebDriver driver1) throws Exception {
		...
		driver.findElement(By.linkText(data.getData(7, 36, 2))).click();// Click
																		// on
